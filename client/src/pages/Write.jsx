    ...
    return (
        <div className='add'>
            <div className='content'>
                <input type="text" placeholder='Title' onChange={e => setCat(e.target.value)} />
            ...
            <div className='menu'>
                ...
                <div className="item">
                    ...
                    <div className="cat">
                        <input type="radio" name="cat" value="technology" id="design" onChange={e => setCat(e.target.value)} />
